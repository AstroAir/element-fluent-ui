 ...
 */
void applyTheme(FluentThemeMode mode, FluentAccentColor accentColor = FluentAccentColor::Blue);
 ...
 */
bool validateContrast(const QColor& foreground, const QColor& background, double level = 4.5);
 ...
 */
QColor adjustContrast(const QColor& color, const QColor& background, double targetRatio = 4.5);
