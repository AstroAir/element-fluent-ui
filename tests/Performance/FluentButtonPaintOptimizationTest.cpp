...
void FluentButtonPaintOptimizationTest::testPaintEventPerformance() {
    ...
    qDebug() << "  Cached rendering:" << cachedTime << "ms for" << iterations << "iterations";
    qDebug() << "  Uncached rendering:" << uncachedTime << "ms for" << iterations << "iterations";
    qDebug() << "  Performance improvement:" << QString::number((double)uncachedTime / cachedTime, 'f', 2) << "x";
...
void FluentButtonPaintOptimizationTest::testConcurrentButtonRendering() {
    ...
    qDebug() << "  Rendered" << buttonCount << "buttons 10 times in" << renderTime << "ms";
...
void FluentButtonPaintOptimizationTest::testStyleChangePerformance() {
    ...
    qDebug() << "  Average time per style change:" << styleChangeTime / 100.0 << "ms";
...
void FluentButtonPaintOptimizationTest::createTestButtons(int count, QList<FluentButton*>& buttons) {
    const QList<FluentButtonStyle> styles = {
        FluentButtonStyle::Default,
        FluentButtonStyle::Primary,
        FluentButtonStyle::Accent,
