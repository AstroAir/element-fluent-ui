...
void AnimationSystemTests::testAnimationBatching() {
    ...
    int batchId2 =
        batch.addAnimation(m_testWidget, "geometry", QRect(0, 0, 100, 100),
                           QRect(50, 50, 200, 200));
...
void AnimationSystemTests::testAnimationPerformance() {
    ...
    QVERIFY(creationTime <
            1000);  // Should create 100 animations in less than 1 second
    QVERIFY(startTime <
            500);  // Should start 100 animations in less than 0.5 seconds
