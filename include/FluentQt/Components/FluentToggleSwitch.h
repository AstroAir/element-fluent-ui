...
enum class FluentToggleSwitchLabelPosition { Left, Right, Above, Below, None };
...
class FluentToggleSwitch : public Core::FluentComponent {
    ...
    Q_PROPERTY(
        QString offText READ offText WRITE setOffText NOTIFY offTextChanged)
    Q_PROPERTY(QIcon onIcon READ onIcon WRITE setOnIcon NOTIFY onIconChanged)
    Q_PROPERTY(
        QIcon offIcon READ offIcon WRITE setOffIcon NOTIFY offIconChanged)
    Q_PROPERTY(
        FluentToggleSwitchSize size READ size WRITE setSize NOTIFY sizeChanged)
    Q_PROPERTY(FluentToggleSwitchLabelPosition labelPosition READ labelPosition
    ...
    Q_PROPERTY(bool showIcons READ showIcons WRITE setShowIcons NOTIFY
                   showIconsChanged)
    Q_PROPERTY(bool showStateText READ showStateText WRITE setShowStateText
                   NOTIFY showStateTextChanged)
...
public:
    ...
    explicit FluentToggleSwitch(const QString& text, bool checked,
...
private:
    ...
    FluentToggleSwitchLabelPosition m_labelPosition{
        FluentToggleSwitchLabelPosition::Right};
