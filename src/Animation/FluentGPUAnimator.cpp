...
bool FluentShaderProgram::loadFromFiles(const QString& vertexPath,
...
bool FluentShaderProgram::loadFromSource(const QString& vertexSource,
...
void FluentShaderProgram::setUniform(const QString& name,
...
void FluentShaderProgram::setUniform(const QString& name,
                                     QOpenGLTexture* texture, int unit) {
...
void FluentGPURenderer::addAnimatedWidget(QWidget* widget,
