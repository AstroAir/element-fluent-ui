...
/**
 * @brief Comprehensive demonstration of FluentQt accessibility and theming
 * features
 *
...
public:
    AccessibilityThemingExample(QWidget* parent = nullptr)
        : QMainWindow(parent) {
        setupAccessibility();
        setupUI();
        setupThemeControls();
...
void AccessibilityThemingExample::setupAccessibility() {
    ...
    setAccessibleDescription(
        "Comprehensive demonstration of accessibility features and theming "
        "capabilities in FluentQt");
...
void AccessibilityThemingExample::setupUI() {
    ...
    Accessibility::setAccessibleDescription(
        m_controlTabs, "Tabbed interface for theme and accessibility controls");
    ...
    Accessibility::setAccessibleDescription(
        m_previewArea,
        "Live preview of theme changes and component appearance");
    ...
    Accessibility::setAccessibleDescription(
        m_previewButton, "Demonstrates button appearance with current theme");
    ...
    Accessibility::setAccessibleDescription(
        m_previewTextBox,
        "Demonstrates text input appearance with current theme");
    ...
    Accessibility::setAccessibleDescription(
        m_previewCombo, "Demonstrates dropdown appearance with current theme");
    ...
    Accessibility::setAccessibleDescription(
        m_previewSlider, "Demonstrates slider appearance with current theme");
    ...
    Accessibility::setAccessibleDescription(
        m_previewSpinBox,
        "Demonstrates number input appearance with current theme");
...
void AccessibilityThemingExample::setupThemeControls() {
    ...
    Accessibility::setAccessibleDescription(
        m_themeModeCombo, "Choose between light, dark, or system theme mode");
    ...
    m_accentColorCombo->addItems({"Blue", "Purple", "Teal", "Green", "Yellow",
                                  "Orange", "Red", "Pink", "Custom"});
    m_accentColorCombo->setCurrentIndex(0);
    Accessibility::setAccessibleName(m_accentColorCombo,
                                     "Accent Color Selection");
    Accessibility::setAccessibleDescription(
        m_accentColorCombo, "Choose the primary accent color for the theme");
    ...
    Accessibility::setAccessibleDescription(
        m_fontSizeSlider, "Adjust the base font size from 8 to 24 points");
    ...
    // Custom color button
    m_customColorButton =
        new Components::FluentButton("Select Custom Color", this);
    m_customColorButton->setButtonStyle(Components::FluentButtonStyle::Outline);
    Accessibility::setAccessibleName(m_customColorButton,
                                     "Custom Color Selector");
    Accessibility::setAccessibleDescription(
        m_customColorButton,
        "Open color picker to select a custom accent color");
    themeLayout->addWidget(m_customColorButton);

    // Custom font button
    m_customFontButton =
        new Components::FluentButton("Select Custom Font", this);
    m_customFontButton->setButtonStyle(Components::FluentButtonStyle::Outline);
    Accessibility::setAccessibleName(m_customFontButton,
                                     "Custom Font Selector");
    Accessibility::setAccessibleDescription(
        m_customFontButton, "Open font dialog to select a custom font family");
    ...
    Accessibility::setAccessibleDescription(
        m_exportButton, "Export current theme settings to a file");
    ...
    Accessibility::setAccessibleDescription(
        m_importButton, "Import theme settings from a file");
    ...
    Accessibility::setAccessibleDescription(
        m_resetButton, "Reset all theme settings to default values");
...
void AccessibilityThemingExample::setupAccessibilityControls() {
    ...
    // High contrast mode
    m_highContrastCheck =
        new Components::FluentCheckBox("Enable High Contrast Mode", this);
    Accessibility::setAccessibleName(m_highContrastCheck,
    ...
    // Screen reader mode
    m_screenReaderCheck =
        new Components::FluentCheckBox("Screen Reader Mode", this);
    Accessibility::setAccessibleName(m_screenReaderCheck,
                                     "Screen Reader Mode Toggle");
    Accessibility::setAccessibleDescription(
        m_screenReaderCheck,
        "Enable enhanced screen reader support and announcements");
    accessibilityLayout->addWidget(m_screenReaderCheck);

    // Keyboard navigation
    m_keyboardNavCheck =
        new Components::FluentCheckBox("Enhanced Keyboard Navigation", this);
    m_keyboardNavCheck->setChecked(true);
    Accessibility::setAccessibleName(m_keyboardNavCheck,
                                     "Keyboard Navigation Toggle");
    Accessibility::setAccessibleDescription(
        m_keyboardNavCheck, "Enable enhanced keyboard navigation features");
    ...
    Accessibility::setAccessibleName(m_reducedMotionCheck,
    ...
    m_validateButton =
        new Components::FluentButton("Validate Accessibility", this);
    m_validateButton->setButtonStyle(Components::FluentButtonStyle::Primary);
    Accessibility::setAccessibleName(m_validateButton,
                                     "Accessibility Validator");
    Accessibility::setAccessibleDescription(
        m_validateButton,
        "Run accessibility validation checks on the current interface");
    toolsLayout->addWidget(m_validateButton);

    m_shortcutsButton =
        new Components::FluentButton("Show Keyboard Shortcuts", this);
    m_shortcutsButton->setButtonStyle(Components::FluentButtonStyle::Default);
    Accessibility::setAccessibleName(m_shortcutsButton,
                                     "Keyboard Shortcuts Help");
    Accessibility::setAccessibleDescription(
        m_shortcutsButton,
        "Display available keyboard shortcuts and navigation help");
    toolsLayout->addWidget(m_shortcutsButton);

    m_contrastButton =
        new Components::FluentButton("Test Color Contrast", this);
    ...
    Accessibility::setAccessibleDescription(
        m_contrastButton, "Test color contrast ratios for WCAG compliance");
    toolsLayout->addWidget(m_contrastButton);

    m_announceButton =
        new Components::FluentButton("Announce Current Settings", this);
    ...
    Accessibility::setAccessibleDescription(
        m_announceButton,
        "Announce current theme and accessibility settings to screen readers");
    ...
    Accessibility::setAccessibleName(m_accessibilityScore,
                                     "Accessibility Score");
    Accessibility::setAccessibleDescription(
        m_accessibilityScore,
        "Current accessibility compliance score out of 100");
    ...
    Accessibility::setAccessibleName(m_accessibilityLog,
                                     "Accessibility Event Log");
    Accessibility::setAccessibleDescription(
        m_accessibilityLog, "Log of accessibility events and announcements");
...
void AccessibilityThemingExample::setupKeyboardShortcuts() {
    ...
    connect(announceShortcut, &QShortcut::activated, this,
            &AccessibilityThemingExample::announceCurrentSettings);
    ...
    connect(helpShortcut, &QShortcut::activated, this,
            &AccessibilityThemingExample::showKeyboardShortcuts);
    m_shortcuts.append(helpShortcut);
}

void AccessibilityThemingExample::setupConnections() {
    // Theme controls
    connect(m_themeModeCombo,
            QOverload<int>::of(&QComboBox::currentIndexChanged), this,
            &AccessibilityThemingExample::onThemeModeChanged);
    connect(m_accentColorCombo,
            QOverload<int>::of(&QComboBox::currentIndexChanged), this,
            &AccessibilityThemingExample::onAccentColorChanged);
    connect(m_fontSizeSlider, &Components::FluentSlider::valueChanged, this,
            &AccessibilityThemingExample::onFontSizeChanged);
    connect(m_customColorButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::onCustomColorSelected);
    connect(m_customFontButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::onCustomFontSelected);
    connect(m_exportButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::exportCurrentTheme);
    connect(m_importButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::importTheme);
    connect(m_resetButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::resetThemeToDefaults);

    // Accessibility controls
    connect(m_highContrastCheck, &Components::FluentCheckBox::toggled, this,
            &AccessibilityThemingExample::onHighContrastToggled);
    connect(m_screenReaderCheck, &Components::FluentCheckBox::toggled, this,
            &AccessibilityThemingExample::toggleScreenReaderMode);
    connect(m_validateButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::validateAccessibility);
    connect(m_shortcutsButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::showKeyboardShortcuts);
    connect(m_contrastButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::testColorContrast);
    connect(m_announceButton, &Components::FluentButton::clicked, this,
            &AccessibilityThemingExample::announceCurrentSettings);

    // Theme change notifications
    auto& theme = Styling::FluentTheme::instance();
    connect(&theme, &Styling::FluentTheme::themeChanged, this,
            &AccessibilityThemingExample::updateThemePreview);
    connect(&theme, &Styling::FluentTheme::themeChanged, this,
            &AccessibilityThemingExample::updateAccessibilityInfo);
}
...
void AccessibilityThemingExample::announceApplicationReady() {
    QTimer::singleShot(500, [this]() {
        announceToUser(
            "FluentQt Accessibility and Theming Example loaded. Press F1 for "
            "keyboard shortcuts.");
        logAccessibilityEvent(
            "Application ready - all accessibility features initialized");
    });
}
...
void AccessibilityThemingExample::onThemeModeChanged(int index) {
    ...
    logAccessibilityEvent(QString("Theme mode changed to: %1")
...
void AccessibilityThemingExample::onAccentColorChanged(int index) {
    ...
    const QList<Styling::FluentAccentColor> colors = {
        ...
        Styling::FluentAccentColor::Teal,   Styling::FluentAccentColor::Green,
        Styling::FluentAccentColor::Yellow, Styling::FluentAccentColor::Orange,
        Styling::FluentAccentColor::Red,    Styling::FluentAccentColor::Pink};

    if (index >= 0 && index < colors.size()) {
        theme.setAccentColor(colors[index]);
        announceToUser(QString("Changed accent color to %1")
                           .arg(m_accentColorCombo->currentText()));
        logAccessibilityEvent(QString("Accent color changed to: %1")
                                  .arg(m_accentColorCombo->currentText()));
    }
}
...
void AccessibilityThemingExample::onHighContrastToggled(bool enabled) {
    ...
    announceToUser(enabled ? "High contrast mode enabled"
                           : "High contrast mode disabled");
    logAccessibilityEvent(
        QString("High contrast mode %1").arg(enabled ? "enabled" : "disabled"));
...
void AccessibilityThemingExample::onCustomColorSelected() {
    QColor color = QColorDialog::getColor(
        m_customAccentColor.isValid() ? m_customAccentColor : Qt::blue, this,
    ...
    if (color.isValid()) {
        ...
        logAccessibilityEvent(
            QString("Custom accent color selected: %1").arg(color.name()));
    }
}
...
void AccessibilityThemingExample::onCustomFontSelected() {
    ...
    QFont font = QFontDialog::getFont(
        &ok, m_customFont.isValid() ? m_customFont : QApplication::font(), this,
        "Select Custom Font");
    if (ok) {
        m_customFont = font;
        QApplication::setFont(font);
        announceToUser(QString("Custom font selected: %1").arg(font.family()));
        logAccessibilityEvent(QString("Custom font selected: %1 %2pt")
                                  .arg(font.family())
                                  .arg(font.pointSize()));
    }
}
...
void AccessibilityThemingExample::validateAccessibility() {
    ...
    // Report results
    QString report =
        QString("Accessibility validation complete. Score: %1/100").arg(score);
    if (!issues.isEmpty()) {
        report += "\nIssues found:\n• " + issues.join("\n• ");
    }
    ...
    announceToUser(
        QString("Accessibility validation complete. Score: %1 out of 100")
            .arg(score));
    logAccessibilityEvent(
        QString("Accessibility validation completed - Score: %1").arg(score));
}
...
void AccessibilityThemingExample::toggleScreenReaderMode(bool enabled) {
    ...
    if (enabled) {
        ...
        announceToUser(
            "Screen reader mode enabled. Enhanced announcements activated.");
...
void AccessibilityThemingExample::testColorContrast() {
    ...
    // Text on background
    qreal textBgRatio =
        theme.contrastRatio(palette.textPrimary, palette.backgroundPrimary);
    ...
    qreal accentBgRatio =
        theme.contrastRatio(accentColor, palette.backgroundPrimary);
...
void AccessibilityThemingExample::announceCurrentSettings() {
    QString settings =
        QString(
            "Current settings: %1 theme mode, %2 accent color, %3 point font "
            "size. "
...
void AccessibilityThemingExample::updateThemePreview() {
    ...
    m_currentThemeLabel->setText(
        QString("Current: %1 Theme with %2 Accent").arg(modeText, accentText));
...
void AccessibilityThemingExample::updateAccessibilityInfo() {
    ...
    m_wcagComplianceLabel->setText(
        QString("WCAG Compliance: %1").arg(compliance));
    logAccessibilityEvent(
        QString("Accessibility info updated - WCAG: %1").arg(compliance));
}
